...
function L70ETC_OnGossipTalk(event, player, pUnit)
   ...
   player:GossipMenuAddItem(9, "播放[部落的力量]", 0, 1)
   player:GossipMenuAddItem(0, "不用担心", 0, 2)
...
function Orca(event, pUnit)
	   ...
	   print "享受烟火吧!" ---Delete this is you want
       pUnit:RemoveEvents();
...
print "这个L70ETCBand脚本是由Xzombie创建的" 
